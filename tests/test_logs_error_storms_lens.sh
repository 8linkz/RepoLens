...
assert_eq "logs domain registers logs lenses" "error-storms,error-cascades,retry-loops,recursive-growth,log-gaps,missing-heartbeats,silent-failures,state-machine-violations" "$logs_lenses"
