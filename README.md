...
| `deploy`     | 1×          | `deployment` domain (26 lenses) or `android` domain (5 lenses) | Server or Android APK audit — inspects a live server or APK target          |
...
## Domains & Lenses (302 total across 31 domains)
...
| **Android**               | `deploy`     | 5 lenses  | APK overview, package metadata, AndroidManifest permissions and component flags, exported IPC components, APK secrets, credentials, internal URLs, WebView security settings, JavaScript bridges, and device-aware Android audit context         |
