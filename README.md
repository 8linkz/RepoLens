...
| `deploy`     | 1×          | `deployment` domain (26 lenses) or `android` domain (6 lenses) | Server or Android APK audit — inspects a live server or APK target          |
...
## Domains & Lenses (303 total across 31 domains)
...
| **Android**               | `deploy`     | 6 lenses  | APK overview, package metadata, AndroidManifest permissions and component flags, exported IPC components, APK secrets, credentials, internal URLs, WebView security settings, JavaScript bridges, Network Security Config, TLS trust, certificate pinning, and device-aware Android audit context |
