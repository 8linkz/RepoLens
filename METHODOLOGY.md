...
LBA takes the opposite approach. By assigning one prompt per concern (314 total), each lens can devote its full context window and specialization depth to a single domain. The advantages of this decomposition include:
